...
class MemoryAgent:
    ...
    def extract_memories(self, message_pair: List[str]) -> List[str]:
        ...
        prompt = (
            ...
            "IMPORTANT: Use [TERM] when the user defines what a word or phrase MEANS "
            "(e.g. 'recent means last 30 days', 'big spenders means total > 50000'). "
            "Use [PREFERENCE] only when the user wants to ALWAYS INCLUDE or EXCLUDE certain data "
            "(e.g. 'only show delivered orders', 'exclude cancelled orders').\n\n"
